...
function main($ouruserid)
{
	...
	$out =  PageHeader($strDatabase . " : Feedback Responses", $strConfigBehave, "", true, false, "", $strDatabase) . $out . PageFooter();
...
//shows all the tables in $strDatabase and allows an admin to drop and clear all data
{
	...
	$out.= adminbreadcrumb(false,  $strDatabase,"tf.php"  . qpre . "db=" . $strDatabase,  "Feedback Responses: " . $strPHP, "") ;
