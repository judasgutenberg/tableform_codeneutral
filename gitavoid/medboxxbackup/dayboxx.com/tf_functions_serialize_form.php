...
//display a form for editing serialized data ($value)
	$out="";
	$thisarr=unserialize(trim($value));
	//i am having trouble unserializing data that was serialized with double quotes in it. i have not yet figured out a solution to this problem
	//so, for the time being, i am making it so if unserialize fails on serialized data then i just dump the serialized data into a tf form for manual editing.
	//june 27 2010
	//$bleh=unserialize('a:1:{s:4:"data";s:74:"{"tag":"tester","disposition":"ANSWERED","vm":0,"duration":11}";}');
	//$bleh=unserialize('a:1:{s:4:"data";s:74:"{"tag":"tester","disposition":"ANSWERED","vm":0,"duration":11}";}');
	///////////////////a:1:{s:4:"data";s:92:""data";s:74:{s:4:"data";s:74:"{"tag":"tester","disposition":"ANSWERED","vm":0,"duration":11}";}
	///////////////////a:1:{s:4:"data";s:80:"{s:4:"data";s:74:"{"tag":"tester","disposition":"ANSWERED","vm":0,"duration":11}";}
	//var_dump($bleh);
	//$thisarr=unserialize(serialize(array("man"=>"dog", "horse"=>"chuckle")));
	//echo unserialize('s:74:"{"tag":"tester","disposition":"ANSWERED","vm":0,"duration":11}"') . "<P>";
	//echo $value . "<P>";
	//var_dump($thisarr);
	...
	foreach ($thisarr as $key => $v)
	{
		...
		{
			CalculateProbableTextAreaDimensions($v, $width, $height, 100);
			//echo $v . " " . $width. "<BR>";
