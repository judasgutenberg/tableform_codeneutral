...
if(strpos("  " .  $_SERVER['SERVER_NAME'], "glamourboxx.com")>0)
{

	define('optionalhost', '');
	define ('our_db',   'glamourboxx');
...
$conn=false;
define('themecolor', '9885ae');
define('textcolorontheme', 'FFFFFF');
define('customertype', 'Customer');
define('eliteprofessionaltype', 'Professional');
define('professionaltype', 'Staffer');
define('locationtype', 'Office');
define('sitename', 'GlamourBoxx.com');
