...
if ( isset($_SESSION['txtsqladmin']['login']) )
{
	...
	else
	{
		...
		{
			error('Invalid page specified, try again with a valid page or <a href="edit.php">Go Home</a>', E_USER_ERROR);
		}
...
<form method="post" action="edit.php?action=login" name="form">
