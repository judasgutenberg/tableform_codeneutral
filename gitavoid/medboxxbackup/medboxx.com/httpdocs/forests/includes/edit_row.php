...
if ( $_GET['finish'] == 1 )
{
	...
	header('Location: edit.php?page=table_edit&action=browse_table&db='.$_GET['db'].'&table='.$_GET['table'].'&s='.$_POST['s'].'&sdir='.$_POST['sdir'].'&scolumn='.$_POST['scolumn'].'&erow='.$_POST['erow']);
	exit;
}
			...
			<table width="100%" height="100%" cellspacing="0" cellpadding="3" border="0">
				<tr>
					<td width="150" valign="top" bgcolor="E5E5E5">
						...
						<form name="form1" method="post" action="edit.php?page=table_edit&action=edit_row&db=<?php echo $_GET['db']; ?>&table=<?php echo $_GET['table']; ?>&finish=1">
