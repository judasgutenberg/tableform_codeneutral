					...
					<td valign="top">
						...
						if ( !empty($_GET['db']) )
						{
							...
							else
							{
								...
								{
									echo "{$indent}\t\t<input type=\"checkbox\" name=\"export_tables[$value]\" style=\"border: 0px solid; background-color: #E1E1E1\" checked> <a href=\"edit.php?page=export_database&db={$_GET['db']}&table=$value&export=-1\">$value</a><br>\n";
								}
						...
						else
						{
							...
							else
							{
								...
								{
									echo "\t\t\t\t\t\t<li><a href=\"edit.php?page=export_database&db={$value}\">{$value}</a>\n";
								}
							}
