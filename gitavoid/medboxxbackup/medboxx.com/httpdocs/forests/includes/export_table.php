			...
			<table width="100%" height="100%" cellspacing="0" cellpadding="3" border="0">
				<tr>
					<td width="150" valign="top" bgcolor="E5E5E5">
						...
						<form name="form1" method="post" action="edit.php?page=export_database&db=<?php echo $_GET['db']; ?>&export=1">
					</td>
					<td valign="top">
						...
						?>
							...
							<tr bgcolor="E1E1E1">
								<td valign="top" width="200"><b>> Export Tables <font size="1">( <a href="edit.php?page=export_database&db=<?php echo $_GET['db']; ?>&export=-1">Export All</a> )</font></b></td>
								<td>
									<input type="checkbox" name="export_tables[<?php echo $_GET['table']; ?>]" style="border: 0px solid; background-color: #E1E1E1" checked><a href="edit.php?page=export_database&db=<?php echo $_GET['db']; ?>&table=<?php echo $_GET['table']; ?>&export=-1"><?php echo $_GET['table']; ?></a><br>
								</td>
							</tr>
							<tr bgcolor="#BFBFBF">
