...
function drop_db ( db )
{
	...
	{
		document.location.href = 'edit.php?page=drop_db&db=' + db;
	}
}
...
function empty_tbl ( tbl, db )
{
	...
	{
		document.location.href = 'edit.php?page=table_edit&action=empty_table&db=' + db + '&table=' + tbl;
	}
}
...
function drop_tbl ( tbl, db )
{
	...
	{
		document.location.href = 'edit.php?page=table_edit&action=drop_table&db=' + db + '&table=' + tbl;
	}
}
...
function drop_column ( col, tbl, db )
{
	...
	{
		document.location.href = 'edit.php?page=table_prop&action=drop_column&db=' + db + '&table=' + tbl + '&column=' + col;
	}
}
...
function submitTableEditForm ( action, clause, db, table, erow )
{
	if ( ( action == 'drop' && confirm('Are you sure you want to drop this record?') != false ) || action == 'edit')
	{
		...
		document.form1.action = 'edit.php?page=table_edit&db=' + db + '&table=' + table + '&action=' + action + '_row';
		document.form1.submit();
	}
}
...
function getPassForUserDrop ( user )
{
	...
	if ( pass != null )
	{
		...
		document.form1.action = 'edit.php?page=users&action=drop&user=' + user;
		document.form1.submit();
	}
}
		...
		if ( ( newpass = prompt("Enter a new password", '') ) != null )
		{
			if ( ( newpass1 = prompt("Enter a new password ( confirm )", '') ) != null )
			{
				...
				else
				{
					...
					document.form1.action = 'edit.php?page=users&action=edit&user=' + user;
					document.form1.submit();
				}
			}
		}
