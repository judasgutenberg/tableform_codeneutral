...
<form method="get" name="form" action="edit.php" onsubmit="if ( document.form.page.value == 'view_database' ) form.submit(); else { create_db(this.database.value); return false; }">
						...
						if ( isset($_GET['msg']) )
						{
							...
							switch ( $_GET['msg'] )
							{
								...
								case '004':
									...
									if ( !empty($_GET['redir']) )
									{
										echo "<meta http-equiv=\"refresh\" content=\"2; url=edit.php?page={$_GET['redir']}\">";
									}
							}
						}
						?>
						...
						<table width="80%" cellspacing="2" cellpadding="3">
							...
							<tr>
								<td valign="top">
									...
									> <a href="edit.php?page=view_databases">View all databases</a><br>
									> <a href="edit.php?page=export_database">Export a database</a><br>
									> <a href="edit.php?page=change_pass">Change your password</a><br>
									> <a href="edit.php?page=users">Add/Edit users</a><br>
								</td>
								<td valign="top">
									...
									> <a href="http://txtsql.sourceforge.net/edit.php?p=docs&title=Documentation">Official Documentation</a><br>
									<hr size="2" color="B0B0B0">
									> <a href="edit.php?page=php_info">Show PHP Information</a>
								</td>
							</tr>
						</table>
					</td>
