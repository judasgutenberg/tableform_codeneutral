...
if ( isset($_GET['action']) && $_GET['action'] == 'finish' )
{
	...
	header('Location: edit.php?page=view_database&db='.$_GET['newdatabase']);
							...
							<tr>
								<td align=center bgcolor=e1e1e1>
									<b><a href="edit.php?page=view_databases&db=<?php echo $_GET['db']; ?>&action=create_database">Create DB</a> &nbsp;&nbsp;&nbsp;&nbsp;
									   ...
									   <a href="edit.php?page=<?php echo $sql->isLocked($_GET['db']) ? 'unlock' : 'lock';?>_database&db=<?php echo $_GET['db']; ?>&go=edit.php?page=view_database%26amp;db={$_GET['db']}"><?php echo $sql->isLocked($_GET['db']) ? 'Unlock' : 'Lock'; ?> DB</a>
									</b>
								</td>
							</tr>
							<tr>
