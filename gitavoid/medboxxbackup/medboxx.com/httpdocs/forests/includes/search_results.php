			...
			<table width="100%" height="100%" cellspacing="0" cellpadding="3" border="0">
				<tr>
					<td width="150" valign="top" bgcolor="E5E5E5">
						...
						<form name="form1" method="post" action="edit.php?page=search&db=<?php echo $_GET['db']; ?>&table=<?php echo $_GET['table']; ?>&finish=1" onsubmit="checkNegatedFuncs();">
					...
					<td valign="top">
						...
						echo "{$indent}\t\t<td align=\"right\">Go to page <select class=\"sel\" onchange=\"document.location.href='edit.php?page=search_results&db={$_GET['db']}&table={$_GET['table']}&s=' + this.value\">";
						...
						if ( !empty($rows) )
						{
							...
							if ( $_GET['s'] > 0 )
							{
								...
								echo "\t\t\t\t\t\t";
								echo "<input type=\"button\" value=\"Last Page\" onclick=\"document.location.href='edit.php?page=search_results&db={$_GET['db']}&table={$_GET['table']}&s={$last}'\">\n";
							}
							...
							if ( $_GET['s'] + 25 < $numrows )
							{
								$next = $_GET['s'] + 26;
								echo "\t\t\t\t\t\t";
								echo "<input type=\"button\" value=\"Next Page\" onclick=\"document.location.href='edit.php?page=search_results&db={$_GET['db']}&table={$_GET['table']}&s={$next}'\">\n";
							}
