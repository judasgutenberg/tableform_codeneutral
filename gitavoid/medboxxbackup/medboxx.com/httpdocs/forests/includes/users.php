			...
			<table width="100%" height="100%" cellspacing="0" cellpadding="3" border="0">
				<tr>
					<td width="150" valign="top" bgcolor="E5E5E5">
						...
						<form name="form1" method="post" action="edit.php?page=users&action=add" onsubmit="checkNewUserForm(); return false;">
					...
					<td valign="top">
						...
						else
						{
							...
							{
								$link       = ( $_SESSION['txtsqladmin']['username'] == $value ) ? 'edit.php?page=change_pass' : 'javascript: getInfoForUserEdit(\''.$value.'\');';
