...
<form method="get" name="form" action="edit.php">
			...
			<table width="100%" height="100%" cellspacing="0" cellpadding="3" border="0">
				<tr>
					...
					<td valign="top">
						...
						<table width="100%" cellpadding="3" cellspacing="1">
							...
							<tr>
								<td align=center bgcolor=e1e1e1>
									<b><a href="edit.php?page=view_databases&db=<?php echo $_GET['db']; ?>&action=create_database">Create DB</a> &nbsp;&nbsp;&nbsp;&nbsp;
									   <a href="edit.php?page=view_database&db=<?php echo $_GET['db']; ?>&action=create_table">Create Table</a> &nbsp;&nbsp;&nbsp;&nbsp;
									   <a href="javascript:drop_db('<?php echo $_GET['db']; ?>')">Drop DB</a> &nbsp;&nbsp;&nbsp;&nbsp;
									   <a href="edit.php?page=export_database&db=<?php echo $_GET['db'];?>&export=-1">Export DB</a> &nbsp;&nbsp;&nbsp;&nbsp;
									   <a href="edit.php?page=rename_db&db=<?php echo $_GET['db']; ?>">Rename DB</a> &nbsp;&nbsp;&nbsp;&nbsp;
									   <a href="edit.php?page=<?php echo $sql->isLocked($_GET['db']) ? 'unlock' : 'lock';?>_database&db=<?php echo $_GET['db']; ?>"><?php echo $sql->isLocked($_GET['db']) ? 'Unlock' : 'Lock'; ?> DB</a>
									</b>
								</td>
							</tr>
							<tr>
						...
						<table width="100%" cellspacing="1" cellpadding="4" border="0">
							...
							else
							{
								foreach ( $tables as $key => $value )
								{
									...
									echo "\t\t\t\t\t\t\t\t<td align=\"left\">> <a href=\"edit.php?page=tbl_edit&db={$_GET['db']}&table=$value&action=browse\">$value</a></td>\n";
									echo "\t\t\t\t\t\t\t\t<td><a href=\"edit.php?page=table_prop&db={$_GET['db']}&table=$value\"><img src=\"images/small_tbl_properties.png\" border=\"0\" alt=\"View Table Properties\"></a></td>\n";
									echo "\t\t\t\t\t\t\t\t<td><a href=\"edit.php?page=table_edit&db={$_GET['db']}&table=$value&action=browse_table\"><img src=\"images/small_tbl.gif\" border=\"0\" alt=\"Browse Table\"></a></td>\n";
									echo "\t\t\t\t\t\t\t\t<td><a href=\"edit.php?page=search&db={$_GET['db']}&table=$value\"><img src=\"images/small_search.png\" border=\"0\" alt=\"Search Table\"></a></td>\n";
									echo "\t\t\t\t\t\t\t\t<td><a href=\"edit.php?page=table_edit&db={$_GET['db']}&table=$value&action=insert_row\"><img src=\"images/small_insert.png\" border=\"0\" alt=\"Insert a Row\"></a></td>\n";
						...
						<form method="get" action="edit.php" name="form2" onsubmit="create_table(this.table.value, this.columns.value); return false;">
