			...
			<table width="100%" height="100%" cellspacing="0" cellpadding="3" border="0">
				<tr>
					...
					<td valign="top">
						...
						<table width="100%" cellspacing="1" cellpadding="4" border="0">
							...
							else
							{
								foreach ( $databases as $key => $value )
								{
									...
									echo "\t\t\t\t\t\t\t\t<td width=\"20\"><a href=\"edit.php?page=view_database&db=$value\"><img src=\"images/small_databases.gif\" border=\"0\" alt=\"View Tables\"></a></td>\n";
									echo "\t\t\t\t\t\t\t\t<td width=\"20\"><a href=\"edit.php?page=rename_db&db=$value\"><img src=\"images/small_rename_database.png\" border=\"0\" alt=\"Rename Database\"></a></td>\n";
									echo "\t\t\t\t\t\t\t\t<td width=\"20\"><a href=\"edit.php?page=export_database&db=$value\"><img src=\"images/small_exportdb.gif\" border=\"0\" alt=\"Export Database\"></td>\n";
									echo "\t\t\t\t\t\t\t\t<td width=\"20\"><a href=\"javascript:drop_db('$value')\"><img src=\"images/small_drop.gif\" border=\"0\" alt=\"Drop Database\"></a></td>\n";
									echo "\t\t\t\t\t\t\t\t<td width=\"20\"><a href=\"edit.php?page=".( $sql->isLocked($value) ? 'unlock' : 'lock' )."_database&db=$value\"><img src=\"images/small_".( $sql->isLocked($value) ? 'unlock' : 'lock' ).".gif\" border=\"0\" alt=\"".ucfirst( $sql->isLocked($value) ? 'unlock' : 'lock' )." Database\"></a></td>\n";
									echo "\t\t\t\t\t\t\t\t<td>".$tables."</td>\n";
									echo "\t\t\t\t\t\t\t</tr>\n";
								}
							}
						...
						<form method="get" action="edit.php" name="form1" onsubmit="create_db(this.database.value); return false;">
