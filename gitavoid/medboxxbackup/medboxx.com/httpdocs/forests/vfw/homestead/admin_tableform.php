...
//a generic form generator that looks at the table's description in the db and then dynamically builds an editor form
   ...
   onmouseover=\"this.className='btn btnhov'\" onmouseout=\"this.className='btn'\" name=\"" . qpre . "submit\" type=\"submit\" value=\"" . $strButtonText ."\">\n";
	...
	$strLowerLeftContent="\n<iframe frameborder=\"0\" marginwidth=\"0\" marginheight=\"0\" width=\"340\" height=\"400\" name=\"foreignstuff\" src=\"" . qbuild("foreign.php", $strDatabase, $strTable, "", $strIDField, $strValDefault). "&" . qpre . "behave=noextras&" . qpre . "iddefault=" .  $strValDefault . "\"></iframe>";

	$strLowerRightContent="\n<iframe frameborder=\"0\" marginwidth=\"0\" marginheight=\"0\" width=\"490\" height=\"400\" name=\"secondarytool\" id=\"idsecondarytool\" src=\"message.php\"></iframe>";
