...
function MultipleEventList($strDatabase, $datecode, $intUserID,  $strSearchTerm="", $strSearchType="", $strFTables)
{
	...
	$out.="<tr><td  align=\"left\" colspan=\"" . intval(count($arrLabels)-2) . "\">" . MASelectedTools(true). "</td><td align=\"right\" >" .  GenericInput(qpre . "submit", "Save") . "</td></tr>\n";
	$out.="</table>\n\n";
...
function CalSearchForm($strDatabase, $strPHP, $strSearchTerm, $strTypeDefault)
{
	...
	$out.= "</td>\n";
	$out.= "<td>\n";
	$strConfig="time|time-practitioner|practitioner-type|type-notes|notes";
