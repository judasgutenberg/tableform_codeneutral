...
function main()
{
	...
	$out =  PageHeader("Help for " . $strField . " in " . $strTable , $strConfigBehave) . $out . PageFooter();
...
function ShowHelp($strDatabase, $strTable,$strField, $strUser)
{
	...
	if ($strUser=="root"  || 1==1)
	{
		$out.="<form name=\"BForm\" method=\"post\" action=\"" . $strPHP . "\" onSubmit=\" return validate_form();\">\n";
