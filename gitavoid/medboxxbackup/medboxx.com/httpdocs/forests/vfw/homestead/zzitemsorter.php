...
include('itemsorter_functions.php');
echo main();
...
function main()
{
	...
	}	//http://localhost/hudson/itemsorter.php?x_table=hud_game_message&x_fromforeigntable=hud_game_group&x_idfield=hud_game_message_id&x_filterfield=hud_game_group_id&x_namefield=message&x_filterid=1&x_toforeigntable=
