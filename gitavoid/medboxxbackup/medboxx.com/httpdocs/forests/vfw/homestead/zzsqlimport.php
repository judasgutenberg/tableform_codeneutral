...
function ReadFileForm($strDatabase, $rootpath)
{
	...
	$out.= adminbreadcrumb(false, $strDatabase, $strPHP . "?" . qpre . "db=" . $strDatabase,  "import SQL","sqlimport.php", "choose upload", "");
	$out.="<form enctype=\"multipart/form-data\" name=\"BForm\" action=\"sqlimport.php\" method=\"post\">\n";
	...
	$out.= "<br>";
	$out.= FileBrowser($rootpath, "sql txt", "sqlimport.php?" . qpre . "submit=Upload", qpre . "filename");
	return $out;
}
...
function ImportForm($strDatabase, $strTable, $analysis,  $filename )
{
	...
	$strClassSecond="bgclasssecond";
	$strPHP="tableform.php";
	$out.= adminbreadcrumb(false, $strDatabase, $strPHP . "?" . qpre . "db=" . $strDatabase,  "import SQL","sqlimport.php", "SQL analysis : " . $filename, "");
	$out.="<form name=\"BForm\" action=\"sqlimport.php\" method=\"post\">\n";
	$tableheader="<table id=\"idsorttable\" class=\"bgclassline\" cellpadding=\"0\" cellspacing=\"1\" border=\"0\" width=\"500\">\n";
	$out.=$tableheader;
	$out.="<tr class=\"bgclassline\"><td colspan=\"2\">\n";
...
function SQLAnalysis($strSQL)
{
	...
	$tableheader="<table id=\"idsorttable2\" class=\"bgclassline\" cellpadding=\"0\" cellspacing=\"1\" border=\"0\" width=\"500\">\n";
	$out.=$tableheader;
