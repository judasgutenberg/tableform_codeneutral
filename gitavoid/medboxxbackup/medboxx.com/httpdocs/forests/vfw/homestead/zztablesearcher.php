			...
			<script>
					function handback(tablename, fieldname, thisvalue, prettyname, returnfield, returnid)
					{
						...
						else
						{
							...
							opener.top.secondarytool.location.href='tableform.php?' +  returnfield + '=' +  returnid + '&" . qpre . "table=" . $strTable . "&" . qpre . "mode=edit&" . qpre . "id=' + thisvalue + '&" . qpre . "idfield=' + fieldname + '&' + fieldname + '=' + thisvalue + '&" . qpre . "behave=closeclickrecycle';
						}
						window.close();
					}
