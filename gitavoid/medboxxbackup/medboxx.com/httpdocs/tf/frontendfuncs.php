...
//echo $intOurLoginID;
	...
	if($type!="large")
	{
		...
		{
			$alwayslogin="<a class=\"nav\" href=\"login.php?" . qpre . "action=&" . qpre . "mode=client" ."\">" . strtolower(customertype) . " login</a> | ";
		}
		
		$alwayslogin.="<a class=\"nav\" href=\"login.php?" . qpre . "action=&" . qpre . "mode=office\">" . strtolower(locationtype) . " login</a> ";
		...
		{ 
			...
			$login="Welcome, <a class='nav' href='reg.php?" . qpre . "profilemode=profile'>" . $displayname . "</a> "; 
				
				//$patientlogin=$alwayspatientlogin;
 
		}
		
		$out.="<span class=\"nav\">" . $login .  "</span> | ";
		//$out.=$patientlogin . "| ";
		if($intOurLoginID!="")
		{
			$out.="<a class=\"nav\" href=\"" .  $_SERVER['PHP_SELF']  . "?" . qpre . "action=logout\">logout</a> | ";
		}
		$out.="<a class=\"nav\" href=\"contact.php?" . qpre . "mode=contactus\">contact us</a>";
...
{
	$out="<div align=\"right\" class=\"nav\">\n";
	$out.="<a class=\"nav\" href=\"index.php?" . qpre . "\">Schedule</a> | 	\n";
	$out.="<a class=\"nav\" href=\"view.php?" . qpre . "table=practitioner\">" . pluralize(professionaltype) . "</a> | 	\n";
	$out.="<a class=\"nav\" href=\"view.php?office_id=" . $intOffficeID . "&x_action=new&x_table=practitioner\">add " .  professionaltype . " </a> |\n ";
	$out.="<a class=\"nav\" href=\"view.php?" . qpre . "table=client&type=client\">" . pluralize(customertype) . " </a> | \n";
	$out.="<a class=\"nav\" href=\"view.php?office_id=" . $intOffficeID . "&x_action=new&x_table=client\">add " .  customertype . " </a>\n";
	$out.="</div>";
	$out.="<div align=\"right\" class=\"nav\">\n";
	$out.="<a class=\"nav\" href=\"reg.php?" . qpre . "profilemode=profile\">edit your " . locationtype . "</a> | 	\n";
	$out.="<a class=\"nav\" href=\"index.php?" . qpre . "displaymode=forceclient\">view your " . locationtype . " homepage</a> 	\n";
	$out.="</div>";
	return $out;
}
