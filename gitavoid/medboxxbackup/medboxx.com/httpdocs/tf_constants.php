...
define('dependenttype', 'Patient');
define('locationtype', 'Office');
define('sitename', 'MedBoxx.com');
define('whatwedoconfig', 'r|what-mb-does:top p|what-mb-does:patientreg p|what-mb-does:infobox p|what-mb-does:scheduling p|what-mb-does:patientreminders |what-mb-does:bottombuttons');
?>