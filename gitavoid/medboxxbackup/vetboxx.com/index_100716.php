...
<table cellpadding=12>
	<tr>
		<td>
			...
			?>
			<p>			<a class="footercontent" href="info_complex.php?config=r|what-mb-does:top+p|what-mb-does:patientreg+w|what-mb-does:infobox+p|what-mb-does:scheduling+p|what-mb-does:patientreminders+|what-mb-does:bottombuttons" ><img src="images/whatdoes.png" width="303" height="51" alt="" border="0"></a>
</p>
