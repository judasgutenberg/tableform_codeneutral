...
function TableMaker($strDatabase, $strTable, $strTypeConfig, $bwlAdvanced=false)
{
	...
	$out.=FieldEditLine($strDatabase, $strTable,  $outcount,"","","", "", true,false,  false, "", "",  "", "", "", "", "", "", "", "", "", "","", "", "", $strTypeConfig,$strUpDownArrows,"hideallbutlast", $strStyleAdvanced,   $autoinccheckboxstyle, $strStyleAdvanced);
