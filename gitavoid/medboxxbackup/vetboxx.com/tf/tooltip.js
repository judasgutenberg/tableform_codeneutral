...
config. FontColor		= '#585a69'
config. FontFace		= 'Verdana,Geneva,tahoma,arial,sans-serif'
...
config. OffsetY			= 6 		// Vertical offset
...
config. Title			= 'LIVE COURSE INFORMATION'		// Default title text applied to all tips (no default title: empty string '')
config. TitleAlign		= 'left'	// 'left' or 'right' - text alignment inside the title bar
config. TitleBgColor	= '#038e00'		// If empty string '', BorderColor will be used
