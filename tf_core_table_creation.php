...
function MakeColumnInfoTables($strDatabase)
{
	...
	forceeditable tinyint default NULL,
	forceuneditable tinyint default NULL,
...
function MakeRelationTables($strDatabase)
{
	...
	$strSQL="
		...
		`disp_column_name` varchar(44) default NULL,
		`sort_column_name` varchar(44) default NULL,
		`sort_descending` tinyint(1) default NULL,
		`column_name` varchar(44) default NULL,
		`f_table_name` varchar(44) default NULL,
		`f_disp_column_name` varchar(44) default NULL,
		`f_sort_column_name` varchar(44) default NULL,
		`f_sort_descending` tinyint(1) default NULL,
		...
		`complete_list_data` tinyint(1) default NULL,
		`max_dropdown` int(11) default NULL,
...
function MakeURLTable()
{
	...
	{
		$strSQL="
		CREATE TABLE " . $strDatabase . "." .  $strTable . "(
		...
		$strSQL="INSERT INTO " .   $strDatabase . "." .  tfpre . "column_info(`table_name`,`column_name`,`width`,`height`,`invisible`,`data_from_multitable_relation`,`label`,`help_text`,`extra_functionality`,`validation_type_id`,`validation_pattern_id`,`fileupload`,`datecreated`,`datemodified`,`forceeditable`,`forceuneditable`,`password`,`force_no_wysiwg`,`force_wysiwg`,`force_text_input`,`force_binary`,`browsetype_id`) VALUES('" .  tfpre . "url','content','','','','','','','','','','','','','','','','1','','0','',''); ";
		$tables = $sql->query($strSQL);
		$out.= sql_error();
	}
