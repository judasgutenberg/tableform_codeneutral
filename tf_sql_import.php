...
function main()
{
	...
	$out =  PageHeader($strDatabase .  IfAThenB($strTable, " : ") . $strTable . " importer", $strConfigBehave, "", true, false, "", $strDatabase) . $strAddedJSTag . $out . PageFooter();
	return $out;
...
function ReadFileForm($strDatabase, $rootpath)
{
	...
	$out.= "<br>";
	$out.= FileBrowser($rootpath, "sql txt", "tf_sql_import.php?" . qpre . "db=" . $strDatabase . "&" . qpre . "submit=Upload", qpre . "filename");
	return $out;
}
