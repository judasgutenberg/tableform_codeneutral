...
include_once('tf_functions_editor.php');
...
function main()
{
	...
	if ($strUser!="")
	{
		...
		if ($intAdminType>1)
			...
			$out.=  DisplayDataTable($strDatabase, $strTable, $idfield, $strColumn, $strPHP, $strDirection, $intRecord, $strSearchString, $strSearchField, $intSearchType, 50, "", 0,6, false, true, true,$launcherfield,  "", "", "", false,false, false, $strDescrFields, $strLimitingConditions, $recordforusewithwhereclause);
			}
	}
